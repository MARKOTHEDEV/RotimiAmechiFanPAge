import ABoutRotimiPics from "../assets/img/rotimi/AboutRotimiAmaechi.jpg"
    ...
    return (
        <section class="about-area" id="aboutROtimi">
             <br /><br /><br />
                ...
                <div class="about-img" style={{padding:"0 .8rem"}}>
                <img src={ABoutRotimiPics} alt="" />
                </div>
                </div>
